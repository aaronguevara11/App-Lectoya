...
class RespuestasHistoriasInteractivas extends StatefulWidget {
  const RespuestasHistoriasInteractivas({Key? key}) : super(key: key);

  @override
  _RespuestasHistoriasInteractivasState createState() =>
      _RespuestasHistoriasInteractivasState();
}

class _RespuestasHistoriasInteractivasState
    extends State<RespuestasHistoriasInteractivas> {
  ...
  Future<void> fetchData() async {
    try {
      ...
      setState(() {
        juego = data['juego'];
        if (juego != null && juego!['resInteractivas'] != null) {
          respuestas = (juego!['resInteractivas'] as List)
              .map((respuesta) => {
