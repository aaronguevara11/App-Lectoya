...
class RespuestasHaremosHoy extends StatefulWidget {
  const RespuestasHaremosHoy({Key? key}) : super(key: key);

  @override
  _RespuestasHaremosHoyState createState() => _RespuestasHaremosHoyState();
}

class _RespuestasHaremosHoyState extends State<RespuestasHaremosHoy> {
  ...
  Future<void> fetchData() async {
    try {
      ...
      setState(() {
        juego = data['juego'];
        if (juego != null && juego!['res_haremos'] != null) {
          respuestas = (juego!['res_haremos'] as List)
              .map((respuesta) => {
