...
class _Cambialo extends State<FormCambialo> {
  ...
  TextEditingController enunciadoController = TextEditingController();
  TextEditingController emocionController = TextEditingController();
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelText: 'Párrafo de la lectura',
                            ...
                            TextFormField(
                              controller: emocionController,
                              maxLines: null,
                              minLines: 1,
                              decoration: InputDecoration(
                                fillColor: Colors.black,
                                labelText: 'Emoción para el final',
                                floatingLabelStyle: const TextStyle(
                                  color: Colors.black,
                                  fontSize: 15,
                                ),
                            ...
                            GestureDetector(
                              onTap: () async {
                                if (formkey.currentState!.validate()) {
                                  ...
                                  final String emocion = emocionController.text;
                                  final response =
                                      await docentesAPI.AgregarCambialo(
                                          enunciado, emocion);
