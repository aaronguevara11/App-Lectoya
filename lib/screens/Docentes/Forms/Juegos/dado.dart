...
class _Dado extends State<FormDado> {
  ...
  TextEditingController sexta_preController = TextEditingController();
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 10),
                            TextFormField(
                              controller: sexta_preController,
                              maxLines: null,
                              minLines: 1,
                              decoration: InputDecoration(
                                fillColor: Colors.black,
                                labelText: 'Sexta pregunta',
                                floatingLabelStyle: const TextStyle(
                                  color: Colors.black,
                                  fontSize: 15,
                                ),
                                ...
                                prefixIcon: const Icon(Icons.filter_6),
                              ),
                              validator: (value) {
                                if (value!.isEmpty) {
                                  return 'Ingrese una pregunta';
                            ...
                            GestureDetector(
                              onTap: () async {
                                if (formkey.currentState!.validate()) {
                                  final String primera_pre =
                                      primera_preController.text;
                                  final String segunda_pre =
                                      segunda_preController.text;
                                  final String tercera_pre =
                                      tercera_preController.text;
                                  final String cuarta_pre =
                                      cuarta_preController.text;
                                  final String quinta_pre =
                                      quinta_preController.text;
                                  final String sexta_pre =
                                      sexta_preController.text;
                                  final response =
                                      await docentesAPI.AgregarDado(
                                          primera_pre,
                                          segunda_pre,
                                          tercera_pre,
                                          cuarta_pre,
